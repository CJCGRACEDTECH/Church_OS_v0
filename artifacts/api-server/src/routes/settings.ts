...
const SETTING_GROUPS = {
  services: {
    defaultServices: [
      ...
      { name: "Friday Night Discipleship", day: "Friday", time: "23:00", mode: "in_person" },
      { name: "Saturday Service", day: "Saturday", time: "19:00", mode: "in_person" },
      { name: "Sunday Service", day: "Sunday", time: "11:00", mode: "in_person" },
    ],
    eventCategories: ["Service", "Discipleship", "Bible Study", "Prayer", "Baptism", "Fasting Season", "Special Event", "Announcement"],
  ...
  giving: {
    ...
    givingGoals: {
      love_offering: 25000,
      tithe: 100000,
      kingdom_commitment: 75000,
      giftings: 18000,
    },
    monthlyGivingGoals: [
      { month: "2026-05", goalCents: 25000000 },
    ],
    recurringGivingOptions: ["weekly", "biweekly", "monthly", "yearly"],
    givingCategories: ["Love Offering", "Tithe", "Kingdom Commitment", "Giftings"],
